...
use finfo;
use OmniForm\Dependencies\Respect\Validation\Rules\Key;
use OmniForm\Dependencies\Symfony\Component\Validator\Constraint;
use OmniForm\Dependencies\Symfony\Component\Validator\Validator\ValidatorInterface as SymfonyValidator;
/** @internal */
interface StaticValidator
{
    ...
    public static function gmdate(string $format = 'Y-m-d') : ChainedValidator;
