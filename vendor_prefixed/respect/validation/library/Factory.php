...
namespace OmniForm\Dependencies\Respect\Validation;

use ReflectionClass;
use ReflectionException;
use ReflectionObject;
use OmniForm\Dependencies\Respect\Validation\Exceptions\ComponentException;
use OmniForm\Dependencies\Respect\Validation\Exceptions\InvalidClassException;
use OmniForm\Dependencies\Respect\Validation\Exceptions\ValidationException;
use OmniForm\Dependencies\Respect\Validation\Message\Formatter;
use OmniForm\Dependencies\Respect\Validation\Message\ParameterStringifier;
use OmniForm\Dependencies\Respect\Validation\Message\Stringifier\KeepOriginalStringName;
...
final class Factory
{
     ...
     * @var string[]
     */
    private $rulesNamespaces = ['OmniForm\\Dependencies\\Respect\\Validation\\Rules'];
    /**
     * @var string[]
     */
    private $exceptionsNamespaces = ['OmniForm\\Dependencies\\Respect\\Validation\\Exceptions'];
    /**
     * @var callable
     */
